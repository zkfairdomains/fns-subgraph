...
export class ReverseRegistrar extends ethereum.SmartContract {
  static bind(address: Address): ReverseRegistrar {
    return new ReverseRegistrar("ReverseRegistrar", address);
  }
