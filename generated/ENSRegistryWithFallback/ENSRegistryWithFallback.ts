...
export class ENSRegistryWithFallback extends ethereum.SmartContract {
  static bind(address: Address): ENSRegistryWithFallback {
    return new ENSRegistryWithFallback("ENSRegistryWithFallback", address);
  }
